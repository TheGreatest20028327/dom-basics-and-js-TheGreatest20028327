...
import OrderOnline from "./online order.js";
import FoodGallery from "./food gallery.js";
...
const Index = () => {
  ...
  const link5 = document.getElementById("online order");
  link5.addEventListener("click", () => {
    content.replaceChild(online, content.childNodes[1]);
  });

  const link6 = document.getElementById("food gallery");
