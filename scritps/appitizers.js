const Appitizers = () => {
  ...
  item2Container.appendChild(app2);
  ...
  item2Container.appendChild(appParagraph2);
  ...
  item2Container.appendChild(appImage2);
  ...
  app3.innerHTML = 'FISH';
  item3Container.appendChild(app3);
  ...
  item3Container.appendChild(appParagraph3);
  ...
  item3Container.appendChild(appImage3);
